...
BOT_TOKEN = environ.get('BOT_TOKEN', "7750523801:AAFGAy3vIHEoT8LwGZA0PyVnoA0QQRiA73k")
...
PICS = (environ.get('PICS', 'https://envs.sh/7N7.jpg')).split() #SAMPLE PIC
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '100220843794').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '--1002428130059')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Jawan:My765592@cluster0.rbwks.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Deendayal_files')

# Others
VERIFY = bool(environ.get('VERIFY', False)) # Verification On ( True ) / Off ( False )
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/How_too_penlink/29')
...
SECOND_SHORTLINK_API = environ.get('SECOND_SHORTLINK_API', 'b62c13862daac9f56fb2c02c6c45b9c6144cd41d')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_too_penlink/29')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002228337057'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Aesthicunivars')
